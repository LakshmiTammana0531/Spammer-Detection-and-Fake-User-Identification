...
<div id="templatemo_main">
    ...
    <div class="col_w600 float_l">
   	  <div class="content_box">
            <h2><span class="style22 style22">View Tweet URLs...</span></h2>
            <p>&nbsp;</p>
            <table width="1109" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
          <tr>
            <td  width="40" height="34"  valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style98">ID</div></td>
            <td  width="146" height="34" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style98">Retweeted Username</div></td>
            <td  width="174" height="34" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style98">Tweet Name</div></td>
            <td  width="257" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style98">Retweeted  URLs </div></td>
            <td  width="133" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style98">Date and Time</div></td>
          ...
          <%
						...
						try 
						{
						   	String query="select * from tweet_url order by username ASC"; 
          ...
          <tr>
            ...
            <td align="center"  valign="middle"><textarea name="textarea" cols="40" rows="8"><%out.println(s3);%></textarea></td>
            <td height="126" align="center"  valign="middle"><%out.println(s4);%></td>
