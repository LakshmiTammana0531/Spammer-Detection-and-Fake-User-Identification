...
<div id="templatemo_main">
    ...
    <div class="col_w600 float_l">
   	  <div class="content_box">
            <h2><span class="style22 style22">View All Spammers Details....!!!</span></h2>
            <p>&nbsp;</p>
            <p class="style105">Negative Spam Detection !!! </p>
            <iframe width="800" height="250" src="Negative.jsp"></iframe>
        <p>&nbsp;</p>
              <p align="left"><a href="UserMain.jsp" class="style20"></a><span class="style105">Sexual Spam Detection !!! </span></p>
			  
			  
			  <iframe width="800" height="250" src="Sexual.jsp"></iframe>
              <p align="left">&nbsp;</p>
              <p align="left"><span class="style105">Offensive Spam Detection !!! </span></p>
			  <iframe width="800" height="250" src="Offensive.jsp"></iframe>
              <p align="left">&nbsp;</p>
              <p align="left"><span class="style105">Hateful Spam Detection !!! </span></p>
			  <iframe width="800" height="250" src="Hateful.jsp"></iframe>
              <p align="left">&nbsp;</p>
              <p align="left"><span class="style105">Volgur Spam Detection !!! </span></p>
			  <iframe width="800" height="250" src="Volgur.jsp"></iframe>
