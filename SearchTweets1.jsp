...
<title>Searched Tweet Details..</title>
...
<div id="templatemo_main">
    ...
    <div class="col_w600 float_l">
        ...
        <h2><span class="style36 style35 style22"><span class="style41">Tweet</span><span class="style24"> <%=request.getParameter("tname")%></span><span class="style41">'s Details..</span></span></h2>
 	 ...
 	 <%
        ...
        <table width="620" border="1" align="center" cellpadding="0" cellspacing="0" >
          <tr >
            ...
            <td height="47" bgcolor="#FF0000" ><div align="center" class="style70 style83">Tweet By </div></td>
            <td width="257"><div align="center" class="style40"><strong><%= creator%></strong></div></td>
          </tr>
          <tr >
            <td height="77" bgcolor="#FF0000" ><div align="center" class="style84"> Tweet Description </div></td>
            <td>
                <textarea name="textarea" cols="40" rows="5"><%= des%></textarea>            </td>
          </tr>
          <tr >
            <td height="72" bgcolor="#FF0000" ><div align="center" class="style84">Tweet Uses </div></td>
            <td><div align="center" class="style40 style81"><strong><%= uses%></strong></div></td>
          </tr>
          <tr >
            <td width="172" height="39" bgcolor="#FF0000" ><div align="center" class="style84">Date </div></td>
          ...
          <tr>
            <td height="57"><div align="left " class="style15 style11" style="margin-left:20px;">
                <div align="center"><strong>Tweet on This Post </strong></div>
            </div></td>
            <td colspan="2">
			<form action="SearchTweets2.jsp" method="post">
		...
		%>
        <p>&nbsp;</p>
              <p align="right"><a href="SearchTweets.jsp" class="style20"><strong>Back</strong></a></p>
      </div>
