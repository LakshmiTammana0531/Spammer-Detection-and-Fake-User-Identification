   	  ...
   	  <div class="content_box">
            ...
            <form id="form1" name="form1" method="post" action="SearchFriends.jsp">
              <table width="453" border="0" align="center" cellpadding="2" cellspacing="2">
                <tr>
                  <td width="185" height="58" bgcolor="#FF0000"><div align="center">
                      <p class="style49">&nbsp;</p>
                    <p class="style49 style22">Enter Friend Name :</p>
                  </div></td>
                  <td width="254"><p>&nbsp; </p>
                      <p>
            ...
            <div class="post_content">
              ...
              <table width="518" height="250" border="3" style="margin:5px 10px 10px 5px;">
                <tr>
                  ...
                  <td width="133" height="27" align="left" bgcolor="#FFFF00"><div align="left" class="style86"><span class="style87" style="margin-left:20px;; font-weight: bold;">User Name :</span></div></td>
                  <td width="185" style="margin-left:20px; color:#000000;"><div align="left" class="style79 style84"><%=s1%></div></td>
                </tr>
                <tr>
                  <td height="25" align="left" bgcolor="#FFFF00"><div align="left" class="style86"><span class="style87" style="margin-left:20px;; font-weight: bold;">E-Mail :</span></div></td>
                  <td style="margin-left:20px; color:#000000;"><div align="left" class="style85"><%=s2%></div></td>
                </tr>
                <tr>
                  <td height="30" align="left" bgcolor="#FFFF00"><div align="left" class="style86"><span class="style87" style="margin-left:20px;; font-weight: bold;">Mobile :</span></div></td>
                  <td style="margin-left:20px; color:#000000;"><div align="left" class="style85"><%=s3%></div></td>
                </tr>
                <tr>
                  <td height="22" align="left" bgcolor="#FFFF00"><div align="left" class="style86"><span class="style87" style="margin-left:20px;; font-weight: bold;">Address :</span></div></td>
                  <td style="margin-left:20px; color:#000000;"><div align="left" class="style85"><%=s4%></div></td>
                </tr>
                <tr>
                  <td height="26" align="left" bgcolor="#FFFF00"><div align="left" class="style86"><span class="style87" style="margin-left:20px;; font-weight: bold;">DOB :</span></div></td>
                  <td style="margin-left:20px; color:#000000;"><div align="left" class="style85"><%=s5%></div></td>
                </tr>
                <tr>
                  <td height="24" align="left" bgcolor="#FFFF00"><div align="left" class="style86"><span class="style87" style="margin-left:20px;; font-weight: bold;">Gender :</span></div></td>
                  <td style="margin-left:20px; color:#000000;"><div align="left" class="style85"><%=s6%></div></td>
                </tr>
                <tr>
                  <td height="24" align="left" bgcolor="#FFFF00"><div align="left" class="style86"><span class="style87" style="margin-left:20px;; font-weight: bold;">Kind Of User :</span></div></td>
                  <td style="margin-left:20px; color:#000000;"><div align="left" class="style85"><%=s8%></div></td>
                </tr>
                <tr>
                  <td height="46" align="left" bgcolor="#FFFF00"><div align="left" class="style86"><span class="style87" style="margin-left:20px;; font-weight: bold;">Status :</span></div></td>
