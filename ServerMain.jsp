...
<div id="templatemo_main">
    ...
    <div class="col_w600 float_l">
    	<div class="content_box">
            <h2><span class="style23"><span class="style24">Welcome to Tweet Server Page </span><span class="style12"><span class="style3">..</span></span></span></h2>
    ...
    <div class="col_w300 float_r">
    	<h2>Server Menu </h2>
            <p><a href="ServerMain.jsp"><strong>Home</strong></a></p>
			 <p><a href="S_AuthorizeUsers.jsp"><strong>View and Authorize Users</strong></a></p>
            <p><a href="S_Add_Filter.jsp"><strong>Add and View Spam Filters </strong></a></p>
            <p><a href="S_UserPostedTweets.jsp"><strong>View All User Posted Tweets</strong></a></p>
			<p><a href="S_View_Tweet_URLs.jsp"><strong>View All User Tweets Based On URLs</strong></a></p>
            <p><a href="S_FriendRR.jsp"><strong>View Friend Request and Response</strong></a></p>
            <p><a href="S_PostedTweets_Reweet.jsp"><strong>View All Tweets with Re-Tweets</strong></a></p>			
            <p><a href="S_RetweetsWithComments.jsp"><strong>View All Tweets , Re-Tweets and Comments</strong></a></p>
			<p><a href="S_View_Spammer_detection.jsp"><strong>View All Spammers Detection</strong></a></p>
			<p><a href="S_View_Fake_UserIdentification.jsp"><strong>View All Fake User Identification</strong></a></p>
			<p><a href="S_Results.jsp"><strong>View Fake User Identification Results</strong></a></p>
			<p><a href="S_Results1.jsp"><strong>View Fake Tweet Identification Results</strong></a></p>
