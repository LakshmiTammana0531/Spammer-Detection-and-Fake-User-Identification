...
<div id="templatemo_main">
    	...
    	<div class="content_box">
            ...
            <form id="form1" name="form1" method="post" action="ServerAuthentication.jsp">
              <table width="423" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td width="197" height="46" align="center" bgcolor="#FFFF00"><span class="style19">
                    <label for="name">Server Name (required)</label>
                  </span> </td>
                  <td width="212"><input id="name" name="userid" class="text" /></td>
                </tr>
                <tr>
                  <td height="72" align="center" bgcolor="#FFFF00"><span class="style19">Password (required)</span></td>
  ...
  <div class="col_w300 float_r">
    	<h2>Sidebar Menu </h2>
      <p><a href="ServerLogin.jsp"><strong>Home</strong></a></p>
